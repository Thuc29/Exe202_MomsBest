      ...
      <Container className="px-4 py-4 ">
        <Navbar expand="md" className="p-0 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center p-2 bg-white/90 shadow-xl rounded-full gap-2">
            ...
            <Button
              variant="outlined"
              className="!rounded-full !font-space-grotesk  !border !border-blue-600/70 !bg-blue-100 !text-blue-600 px-3 py-1 text-sm font-medium hover:!bg-pink-200 transition-colors flex items-center gap-2"
            >
